  ...
  return (
    <div className="max-w-2xl mx-auto space-y-12 py-12 animate-in fade-in duration-500">
      ...
      <section className="text-center space-y-6">
        ...
        <button
          onClick={panic}
          className="group relative px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-full shadow-[0_0_30px_rgba(220,38,38,0.5)] hover:shadow-[0_0_50px_rgba(220,38,38,0.8)] transition-all active:scale-95"
        >
          <span className="flex items-center gap-2 text-xl">
            <Zap className="fill-yellow-300 text-yellow-300 animate-pulse" />
            QUEBRAR INÉRCIA AGORA
          </span>
        </button>

        {strategy && (
          <div className="bg-card border border-red-900/50 p-6 rounded-xl animate-in fade-in slide-in-from-bottom-4">
      ...
      {/* Focus Timer */}
      <section className="bg-card border border-border rounded-xl p-8 flex flex-col items-center">
        <h3 className="text-lg font-mono text-muted-foreground uppercase tracking-widest mb-6">
        ...
        <div className="flex gap-4">
          ...
          >
            {active ? <Pause className="fill-white text-white" /> : <Play className="fill-white text-white ml-1" />}
          </button>
          <button
            onClick={resetTimer}
